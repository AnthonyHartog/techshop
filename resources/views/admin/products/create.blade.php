                ...
                <div class="bg-slate-200 p-4 shadow-lg rounded-md">
                    <div class="flex justify-between">
                        <div class="">
                            ...
                            <input class="bg-gray-300 text-black placeholder-gray-500 border-none rounded-md shadow-sm" style="width: 500px" type="text" name="name" placeholder="Naam">
                            @error('name')
                        ...
                        <div class="">
                            ...
                            <input class="bg-gray-300 text-black placeholder-gray-500 border-none rounded-md shadow-sm" style="width: 500px" type="number" name="price" min="0" placeholder="Naam">
                            @error('price')
                                <div class="text-red-600">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mt-8">
                        ...
                        @error('description')
                            <div class="text-red-600">{{ $message }}</div>
                        @enderror
                        <textarea class="bg-gray-300 text-black placeholder-gray-500 resize-none border-none rounded-md shadow-sm p-2" style="width: 100%" name="description" id="" cols="30" rows="10" placeholder="Beschrijving..."></textarea>
                    </div>
                </div>
